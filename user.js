    ...
    hidd="hidden";
        ...
        const addTableUser = (users) => {
            ...
            let userHtml = `
                    ...
                    <td> <button class="modifer " onclick = "zonModif(${users.idUser})">modif user </button>   </td>
                    ...
                    <td> <button class="modifer " onclick = "modiferUser(${users.idUser})" ${ users.hid}>validate </button>   </td>
